...
```sh
grep -rl 'vsftwelvepoc1' ./ | xargs sed -i '' 's/vsftwelvepoc1/{YOUR INTEGRATION NAME}/g'
```
...
Want to contribute? Ping us on `vsftwelvepoc1` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/vsftwelvepoc1.git
    cd vsftwelvepoc1
    ```
...
- [vsftwelvepoc1 integration Documentation](https://docs.vuestorefront.io/vsftwelvepoc1)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `vsftwelvepoc1` channel on [our Discord](discord.vuestorefront.io).
