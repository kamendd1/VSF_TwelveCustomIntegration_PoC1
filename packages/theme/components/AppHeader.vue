<template>
  <div>
    ...
    <SearchResults :visible="isSearchOpen"
                   :result="result"
                   :term="term"
                   @close="closeSearch"
...
<script>
  ...
  import { useCart, useUser, cartGetters } from '@vue-storefront/vsftwelvepoc1';
  ...
  export default {
    ...
    setup(props, { root }) {
      ...
      const closeSearch = () => {
        ...
        console.warn('outcommented "const isWishlistIconClicked = event.path.find(..." because event doesnt have a property named "path"')
